...
export const validateEmailMFA = ({ code, time }: IProps) => {
  return `
  <!DOCTYPE html>
                  ...
                  <tr>
                    <td style="padding:0 0 36px 0;color:#153643;">
                      <p style="margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">
                        Tu código para acceder a la plataforma es:
                      </p>
                      <h3 style="text-align: center; font-size: 40px">${code}</h3>
                      <p style="margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">
                        El código expirará en ${time} minutos.
                      </p>
                      <p style="margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">
                        Si no has intentado loguearte, ignora este mensaje.
                      </p>
                    </td>
                  </tr>
                </table>
